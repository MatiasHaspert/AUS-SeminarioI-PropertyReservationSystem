...
namespace Infrastructure.Context
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configuración para que DateOnly sea compatible con SQL Server de forma segura
            foreach (var entityType in modelBuilder.Model.GetEntityTypes())
            {
                ...
                {
                    // Chequeamos el tipo de propiedad para aplicar la conversión adecuada
            ...
            // Filtro global para Property, cualquier consulta excluirá las propiedades eliminadas lógicamente

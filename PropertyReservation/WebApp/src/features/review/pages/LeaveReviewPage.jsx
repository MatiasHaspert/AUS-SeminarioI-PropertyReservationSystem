...
export default function LeaveReviewPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(error);
            const message = error?.response?.data || "No pudimos publicar tu reseña. Intentá nuevamente.";
            toast(typeof message === "string" ? message : "Error al publicar la reseña.", "error");
        } finally {
            setSubmitting(false);
        }
    };

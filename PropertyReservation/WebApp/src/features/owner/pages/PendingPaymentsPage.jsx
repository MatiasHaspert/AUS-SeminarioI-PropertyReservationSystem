...
export default function PendingPaymentsPage() {
    ...
    const handleStatusChange = async (paymentId, newStatus) => {
        ...
        try {
            ...
            toast(`Pago ${actionText} exitosamente.`, newStatus === 1 ? "success" : "info");
        } catch (error) {
            console.error("Error al actualizar pago:", error);
            toast("Ocurrió un error al procesar el pago.", "error");
        } finally {
                                ...
                                <div className="card-body">
                                    <div className="d-flex justify-content-between align-items-start mb-3">
                                        <div>
                                            ...
                                            <small className="text-muted d-block">
                                                Método: <span className="fw-bold">{payment.paymentMethod}</span>
                                            </small>
                                        </div>
                                    ...
                                    <div className="d-flex gap-2">
                                        ...
                                        <button 
                                            ...
                                            title="Rechazar Pago"
                                        >
                                            {processingId === payment.id ? <FontAwesomeIcon icon={faSpinner} spin /> : <FontAwesomeIcon icon={faTimes} />}
                                        </button>

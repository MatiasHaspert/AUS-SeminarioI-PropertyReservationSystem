...
const PAYMENT_METHODS = [
    { value: 0, label: "Tarjeta de Credito", icon: faCreditCard },
    { value: 1, label: "Tarjeta de Debito", icon: faMoneyCheckAlt },
    { value: 2, label: "PayPal", icon: faPaypal },
    { value: 3, label: "Transferencia Bancaria", icon: faUniversity },
];
...
export default function ReservationCheckoutPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(error);
            toast("Error al subir el pago. Intentá nuevamente.", "error");
        } finally {
            setUploading(false);
        }
    };

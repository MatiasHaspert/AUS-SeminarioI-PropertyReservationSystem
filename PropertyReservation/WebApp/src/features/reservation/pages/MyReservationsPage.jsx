...
const STATUS_MAP = {
    ...
    // El Owner rechazó el pago.
    "Rejected": { label: "Rechazada", color: "bg-danger text-white", icon: faTimesCircle, action: null },
    ...
    if (reservations.length === 0) {
        return (
            <div className="container mt-5 text-center py-5 bg-light rounded shadow-sm">
                ...
                <button className="btn btn-primary mt-3" onClick={() => navigate('/')}>Explorar Propiedades</button>
            </div>
        );
    }
                                        ...
                                        <div className="card-body d-flex flex-column h-100">
                                            ...
                                            <div className="row g-3 mb-3 bg-light p-2 rounded mx-0">
                                                <div className="col-sm-6">
                                                    ...
                                                    <span className="text-dark">{formatDate(res.startDate)} al {formatDate(res.endDate)}</span>
                                                </div>
                                                <div className="col-sm-6">

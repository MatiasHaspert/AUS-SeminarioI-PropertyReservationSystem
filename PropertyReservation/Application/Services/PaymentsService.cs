...
namespace Application.Services
{
    public class PaymentsService
    {
        ...
        public async Task<(string ProofPath, string ContentType)> GetPaymentProofUrl(Guid paymentId)
        {
            ...
            // Validar que el usuario owner o guest tenga permiso
        ...
        public async Task<List<PendingPaymentListDTO>> GetPaymentsUnderReview()
        {
            ...
            // Obtener los pagos pendientes de las propiedades del owner
            var payments = await _paymentsRepository.GetUnderReviewPaymentsByOwnerIdAsync(ownerId);
        ...
        public async Task ChangeStatusPayment(Guid paymentId, ChangePaymentStatusDTO status)
        {
            ...
            // Validar que la reserva pertenezca a una propiedad del owner
            if (payment.Reservation.Property.OwnerId != ownerId)

...
namespace WinFormsApp
{
    public partial class AmenityManagementForm : Form
    {
        ...
        private async void btnRefresh_Click(object sender, EventArgs e) => await LoadAmenitiesAsync();
        ...
        private async void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            // CU-08 5c — el contador de propiedades referenciando el amenity todavía no se expone
            // en el listado actual. La confirmación pide consentimiento explícito por si la relación
            // many-to-many está en uso.
            if (MessageBox.Show(
